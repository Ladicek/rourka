...
oc process ci-fmp-basic-template CI_NAME=ci-fmp-spring-boot-http-booster            CI_DESCRIPTION="Spring Boot | 100: HTTP API"        CI_GIT_URL=https://github.com/snowdrop/spring-boot-http-booster            CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-fmp-basic-template CI_NAME=ci-fmp-spring-boot-crud-booster            CI_DESCRIPTION="Spring Boot | 101: CRUD"            CI_GIT_URL=https://github.com/snowdrop/spring-boot-crud-booster            CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-fmp-basic-template CI_NAME=ci-fmp-spring-boot-configmap-booster       CI_DESCRIPTION="Spring Boot | 102: ConfigMap"       CI_GIT_URL=https://github.com/snowdrop/spring-boot-configmap-booster       CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-fmp-sso-template   CI_NAME=ci-fmp-spring-boot-http-secured-booster    CI_DESCRIPTION="Spring Boot | 103: SSO"             CI_GIT_URL=https://github.com/snowdrop/spring-boot-http-secured-booster    CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-fmp-basic-template CI_NAME=ci-fmp-spring-boot-health-check-booster    CI_DESCRIPTION="Spring Boot | 104: Health Check"    CI_GIT_URL=https://github.com/snowdrop/spring-boot-health-check-booster    CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-fmp-basic-template CI_NAME=ci-fmp-spring-boot-circuit-breaker-booster CI_DESCRIPTION="Spring Boot | 106: Circuit Breaker" CI_GIT_URL=https://github.com/snowdrop/spring-boot-circuit-breaker-booster CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -

oc process ci-s2i-basic-template CI_NAME=ci-s2i-spring-boot-http-booster            CI_DESCRIPTION="Spring Boot | 100: HTTP API"        CI_GIT_URL=https://github.com/snowdrop/spring-boot-http-booster            CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-s2i-basic-template CI_NAME=ci-s2i-spring-boot-crud-booster            CI_DESCRIPTION="Spring Boot | 101: CRUD"            CI_GIT_URL=https://github.com/snowdrop/spring-boot-crud-booster            CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-s2i-basic-template CI_NAME=ci-s2i-spring-boot-configmap-booster       CI_DESCRIPTION="Spring Boot | 102: ConfigMap"       CI_GIT_URL=https://github.com/snowdrop/spring-boot-configmap-booster       CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -
#oc process ci-s2i-sso-template   CI_NAME=ci-s2i-spring-boot-http-secured-booster    CI_DESCRIPTION="Spring Boot | 103: SSO"             CI_GIT_URL=https://github.com/snowdrop/spring-boot-http-secured-booster    CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-s2i-basic-template CI_NAME=ci-s2i-spring-boot-health-check-booster    CI_DESCRIPTION="Spring Boot | 104: Health Check"    CI_GIT_URL=https://github.com/snowdrop/spring-boot-health-check-booster    CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-s2i-basic-template CI_NAME=ci-s2i-spring-boot-circuit-breaker-booster CI_DESCRIPTION="Spring Boot | 106: Circuit Breaker" CI_GIT_URL=https://github.com/snowdrop/spring-boot-circuit-breaker-booster CI_GIT_REF=master $ADDITIONAL_OPTIONS | oc apply -f -
