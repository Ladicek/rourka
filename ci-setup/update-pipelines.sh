...
oc process ci-basic-template CI_NAME=ci-spring-boot-http-booster            CI_DESCRIPTION="Spring Boot | 100: HTTP API"        CI_TYPE="Fabric8 Maven plugin" CI_GIT_URL=https://github.com/snowdrop/spring-boot-http-booster            $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-basic-template CI_NAME=ci-spring-boot-crud-booster            CI_DESCRIPTION="Spring Boot | 101: CRUD"            CI_TYPE="Fabric8 Maven plugin" CI_GIT_URL=https://github.com/snowdrop/spring-boot-crud-booster            $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-basic-template CI_NAME=ci-spring-boot-configmap-booster       CI_DESCRIPTION="Spring Boot | 102: ConfigMap"       CI_TYPE="Fabric8 Maven plugin" CI_GIT_URL=https://github.com/snowdrop/spring-boot-configmap-booster       $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-sso-template   CI_NAME=ci-spring-boot-http-secured-booster    CI_DESCRIPTION="Spring Boot | 103: SSO"             CI_TYPE="Fabric8 Maven plugin" CI_GIT_URL=https://github.com/snowdrop/spring-boot-http-secured-booster    $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-basic-template CI_NAME=ci-spring-boot-health-check-booster    CI_DESCRIPTION="Spring Boot | 104: Health Check"    CI_TYPE="Fabric8 Maven plugin" CI_GIT_URL=https://github.com/snowdrop/spring-boot-health-check-booster    $ADDITIONAL_OPTIONS | oc apply -f -
oc process ci-basic-template CI_NAME=ci-spring-boot-circuit-breaker-booster CI_DESCRIPTION="Spring Boot | 106: Circuit Breaker" CI_TYPE="Fabric8 Maven plugin" CI_GIT_URL=https://github.com/snowdrop/spring-boot-circuit-breaker-booster $ADDITIONAL_OPTIONS | oc apply -f -
